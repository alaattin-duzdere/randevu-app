package RandevuApp.security.config;

import RandevuApp.security.filter.JwtBlacklistFilter;
...
public class SecurityConfig {
    ...
    private final AuthProperties authCoreProperties;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                    .requestMatchers(authCoreProperties.getWhitelist().toArray(new String[0])).permitAll()
